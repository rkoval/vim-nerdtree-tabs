...
fun! s:VimEnterHandler()
  let l:open_nerd_tree_on_startup = (g:nerdtree_tabs_open_on_console_startup == 1 && !has('gui_vimr') && !has('gui_running')) ||
                                  \ (g:nerdtree_tabs_open_on_gui_startup == 1 && (has('gui_vimr') || has('gui_running')))
